...
export const InfiniteMovingCards = ({
  ...
  return (
    <div className="scroller relative max-w-7xl overflow-hidden">
      <ul
        ref={scrollerRef}
        className={`flex min-w-full gap-4 py-4 h-[250px] w-max flex-nowrap animate-scroll ${speedClass} ${
      ...
      >
        {duplicatedItems.map((item, idx) => (
          <li
            key={idx}
            className="w-[350px] max-w-full rounded-2xl border border-slate-700 px-6 py-8 md:w-[450px] bg-gradient-to-r  from-black via-black text-gray-100 shadow-xl flex-shrink-0"
          >
